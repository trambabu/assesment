package com.json.file.process.demo.processor;
...
public class ValidationJsonWithJsonSchema {
    ...
    public void validateJsonWithJsonSchema() {
    	File schemaFile = new File("addresses_schema_1.json");
	    File jsonFile = new File("addresses.json");
	    	
	    try {
			if (ValidationJsonWithJsonSchema.isJsonValid(schemaFile, jsonFile)){
